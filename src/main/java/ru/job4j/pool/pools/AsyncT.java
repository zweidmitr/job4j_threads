...
/**
 * 1. "inline многопоточность". Для написания асинхронного кода вам практически
 * не нужно задумываться о потоках. Достаточно создать асинхронную задачу
 * <p>
 * 2. Удобно использовать для мелких относительно независимых задач.
 * Под мелкими здесь подразумевается,
 * что асинхронные задачи должны исполняться быстрее главного потока,
 * особенно при использовании CompletableFuture,
